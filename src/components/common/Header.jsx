...
const Header = ({ setFilters }) => {
  ...
  return (
    <div className="ml-6 mt-8 mb-8 max-w-310">
      ...
      <h2 className="font-bold text-[24px] sm:text-[28px] lg:text-[32px] leading-[100%] text-[#0B0C1A]">
        Remediation Tracker
      </h2>

      <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 min-[1500px]:grid-cols-4 gap-4 lg:gap-6">
